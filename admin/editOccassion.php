 ...
 <?php include('sidebar.php') ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit occasion
        <small>edit occasion here</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
       <!--  <li><a href="#">Projects</a></li> -->
        <li class="active">Edit occasion</li>
      </ol>
    </section>
 ...
 <div class="row">
      <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="editOccassion.php?id=<?php echo $occasion['id']; ?>" method="POST" enctype="multipart/form-data">
