...
<?php
   ...
   if (isset($_GET["Id"])) {
			...
			$Service = mysqli_fetch_array($result,MYSQLI_ASSOC);
			 ...
			 $Title = mysqli_real_escape_string($con,$Service['Title']); 
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST["Service"])) {
     ...
     if(count($errors)==0){
		...
		$sql = "Update styling_service set Tittle = '$Tittle',image= '$design_file_name',active = '$status' where Id = '$Id' ";
		//echo $sql;
			...
			<input type="hidden" name="Id" value="<?php echo $Service['Id']; ?>" >
              <div class="box-body">
				<div class="form-group">
                  ...
                  <input type="text" class="form-control" Id="Service"  name="Service" placeholder="Enter Service Title" value="<?php echo $Title; ?>" required >
                </div>
